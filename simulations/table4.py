...
if __name__ == '__main__':
    ...
    df0_rg, df0b_rg, df1_rg, df1b_rg, df2_rg, df2b_rg, stats_rg, _ = runSimulation(trackID='Swiss', nRuns=5, brakeType='rg')
    df0_pn, df0b_pn, df1_pn, df1b_pn, df2_pn, df2b_pn, stats_pn, _ = runSimulation(trackID='Swiss', nRuns=5, brakeType='pn')
